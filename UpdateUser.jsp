				...
				<form action="UpdateUserServlet" method="post">
					...
					<p>
						<input type="text" name="login_id" class="form-control"
							pattern="^[0-9A-Za-z]+$" value="<c:out value="${user.loginId}" />" required>
					</p>
					<label>パスワード(変更の場合のみ)</label>

					<p>
						<input type="text" name="login_pass" class="form-control" pattern="^[0-9A-Za-z]+$">
					</p>

					<div class="form-group">
						<label for="group">所属グループ（必須）</label> <select class="form-control"
					...
					<a href="UserMoreServlet?id=<c:out value="${user.id}" />">
